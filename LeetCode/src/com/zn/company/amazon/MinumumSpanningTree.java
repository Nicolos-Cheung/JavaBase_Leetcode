...
public class MinumumSpanningTree {
	...
	public static void main(String[] args) {
		ArrayList<Connection> connections = new ArrayList<>(); // connections.add(new
																// Connection("A","B",6));
	...
	private static ArrayList<Connection> getLowCost(ArrayList<Connection> connections) {
	...
	private static boolean union(Map<String, Integer> map, String a, String b) {
		...
		int aU = map.get(a);
		int bU = map.get(b); // if(aU == bU) return false;
